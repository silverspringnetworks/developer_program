==================================================
|       Arduino MilliShield Reference App        |
==================================================
...
7.i   If your board is an Arduino M0, M0 Pro, Arduino/Genuino Zero or ZERO Pro; 
      in the search bar, type RTC then locate and install the RTCZero library
	 
7.ii  If your board is an Arduino Due; in the search bar, type RTC then locate 
      and install the RTCDue library

7.iii Do you have the DHT11 sensor? If yes, use Manage Libraries to locate and install the following:
	  
	  * Adafruit Unified Sensor
	  * DHT Sensor Library
	  
8. In the IDE, go Tools/Board/Boards Manager and the Boards Manager window should appear

8.i   Use the search bar to locate your board e.g. M0 Pro

8.ii  If your board is an Arduino M0, M0 Pro, Arduino/Genuino Zero or ZERO Pro; 
      use the drop-down menu, select board support package 1.6.14 and click Install

8.iii If your board is an Arduino Due; use the drop-down menu, select board support package 1.6.11 and click Install
...
https://portal7-stage.mitangi.com/milli-developer-kit-add-new-sensor
...
Arduino MilliShield Software Version Number: 1.3.1
==================================================
- Re-wrote the Observe code to be the same on M0, M0 Pro and Due
- Tested on M0 Pro and Due
- For now we will only support M0, M0 Pro and Due
