...
/*
 * NOTE: Special Add. Move to it's own file?
 * Called by __libc_init_array() in main.cpp. Usually provided by crt startup, the crti version has an endless loop.
 * This function does not do anything se we just stub it out.
 */
void _init ()
{
}
