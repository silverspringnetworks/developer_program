...
{
    /// <summary>
    /// Encapsulates each attribute name/value pair.
    /// </summary>
    public class CoApLinkAttribute
    {
        ...
        /// Default constructor
        /// </summary>
        public CoApLinkAttribute()
        { }
        /// <summary>
        /// Constructor that parses out the name/value pair
        /// </summary>
        /// <param name="pair">the name/value pair</param>
        public CoApLinkAttribute(string pair)
        {
            string[] nameValue = pair.Split('=');
            if (nameValue.Length > 0)
            {
                __Name = nameValue[0];
                if (__Name == LinkAttribute.Observable)
                    __Value = true;
            }
        ...
        {
            return __Name + "=" + __Value.ToString();
        }
