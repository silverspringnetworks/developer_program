...
{
    /// <summary>
    /// Static settings related to CoAP calls
    /// </summary>
    public class CoApSettings
    {
        ...
        /// <summary>
        /// Whether or not to make the CoAP call confirmable
        /// </summary>
        ...
        /// <summary>
        /// Whether or not to make the CoAP call non-confirmable.
        /// This is just the opposite of Confirmable.  The same variable is used.
        /// It was added to ease programming.
        /// </summary>
        ...
        /// <summary>
        /// How long to wait for a response before assuming that the request timed out.
        /// </summary>
