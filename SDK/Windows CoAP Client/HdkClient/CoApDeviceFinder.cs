...
{
    /// <summary>
    /// Base class for device finder of various network types.
    /// </summary>
    public abstract class CoApDeviceFinder : CoApBase
    {
        /// <summary>
        /// Overloaded by the instance of each network type.
        /// </summary>
        /// <returns></returns>
        public abstract CoApDevices LoadNodes();
