...
{
    /// <summary>
    /// Base class for all Delete classes
    /// </summary>
    public class CoApDelete : CoApBase
    {
        ...
        /// <summary>
        /// Translate the request to a byte stream.
        /// </summary>
        /// <returns>a byte stream representing the current request</returns>
