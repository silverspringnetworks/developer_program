...
{
    /// <summary>
    /// This class is used to generate a CoApResources object
    /// based on a response from the CoAP Gateway.
    /// </summary>
    public class CoApDiscoveryResponse
    {
        private CoApResources __Resources;

        /// <summary>
        /// Default constructor.
        /// </summary>
        public CoApDiscoveryResponse()
            {}
        /// <summary>
        /// Constructor that takes the gateway discovery response and 
        /// produces a resource list for the target device.
        /// </summary>
        /// <param name="resp">the string containing all resources discovered</param>
        public CoApDiscoveryResponse(string resp)
        {
            __Resources = new CoApResources(resp);
        }
        /// <summary>
        /// The CoApResources object generated when this object was instantiated.
        /// </summary>
        ...
        /// <summary>
        /// String representation of the resources discovered.
        /// </summary>
        /// <returns>a string containing all resources discovered</returns>
        public override string ToString()
        {
            string resp = "unknown";
            resp = __Resources.ToString();
            return resp;
        }
    }
}
